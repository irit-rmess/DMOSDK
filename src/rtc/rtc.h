 ...
 *
 * Configures the low frequency clock and initializes a RTC instance.
 */
int rtc_init();

/**
 * @brief Checks if RTC is inialized 
 *
 * @return true if inialized, false otherwise
 */
bool rtc_is_inialized();

/**
 * @brief Gives a timestamp based on the RTC
 *
 * @return timestamp
 */
